  ...
  return (
    <div className="flex flex-col min-h-screen p-6 text-white bg-Bokara-Grey">
      <div className="container w-full max-w-5xl p-8 ">
          ...
          <div className="flex flex-row flex-wrap gap-6 mt-4">
            {selectedPumps.map((pump) => {
              ...
              return (
                <div
                  key={pump.id}
                  className="flex flex-col items-center justify-center w-40 gap-2 px-4 py-4 text-center border shadow-md rounded-xl border-School-Bus"
                >
        ...
        <Button
          className="py-2 text-white shadow-md px-14 rounded-xl"
          onClick={() => {
            const success = handleAddAndSubmit();
            if (success) {
