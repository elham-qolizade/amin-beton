      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-2 text-white border border-gray bg-Bokara-Grey hover:border-School-Bus rounded"
          >
            ...
            {concreteTypes.map((type) => (
              <option
                key={type.id}
                value={type.id}
                title={type.title} // نمایش متن کامل در Tooltip
              >
                {type.title.length > 30
                  ? type.title.slice(0, 30) + "..."
                  : type.title}
              </option>
            ))}
          </select>
