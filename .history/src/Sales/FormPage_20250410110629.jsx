...
const Modal = ({ message, onClose }) => (
  <div
    className="modal-overlay items-center fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 "
    onClick={onClose}
  >
...
const FormPage = () => {
  ...
  return (
    <div className="bg-Bokara-Grey flex  items-center h-screen ">
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <DatePicker
              ...
              className="w-full p-2 pl-4 text-black bg-Bokara-Grey border border-l-4 border-l-Looking-Glass focus:outline-none focus:ring-1 focus:ring-School-Bus"
            />
