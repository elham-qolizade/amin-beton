...
function SaleProject() {
  ...
  onst[(deliveryTime, setDeliveryTime)] = useState("");
    ...
    <div className="min-h-screen p-8 bg-gray-100 bg-Bokara-Grey">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        <div className="flex flex-row items-center justify-center w-full mt-4">
          ...
          <div className=" flex flex-col items-center justify-center p-6 rounded-lg shadow-lg bg-Bokara-Grey">
            <h2 className="mb-4 text-lg text-white">انتخاب ساعت تحویل</h2>
            <Time
              type="time"
              value={selectedTime}
              onChange={(newTimeStr) => setDeliveryTime(newTimeStr)}
              className="w-full p-2 border border-gray-300 rounded"
            />
