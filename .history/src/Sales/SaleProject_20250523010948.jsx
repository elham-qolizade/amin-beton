...
function SaleProject() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (typesRes.data.length > 0 && newOrder.concrete_type === "") {
          setNewOrder((prev) => ({
            ...prev,
            concrete_type: typesRes.data[0].value, // یا هر فیلدی که اون آبجکت‌ها دارن
          }));
        }
      } catch (err) {
  ...
  console.log("مقدار newOrder.concrete_type:", newOrder.concrete_type);
  console.log("لیست concreteOptions:", concreteOptions);
  return (
    <div className="min-h-screen p-8 bg-gray-100 bg-Bokara-Grey">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        <div>
          ...
          console.log(newOrder.concrete_type, concreteOptions);
          <Select
            placeholder=""
