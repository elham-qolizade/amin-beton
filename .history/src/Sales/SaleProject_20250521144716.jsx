  ...
  return (
    <div className="min-h-screen p-8 bg-gray-100 bg-Bokara-Grey">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        {/* تقویم و انتخاب ساعت */}
        <div className="flex md:flex-row flex-col items-center justify-center w-full mt-4">
          <CustomCalendar
            selectedDay={selectedDay}
            setSelectedDay={setSelectedDay}
          />

          <div className=" flex flex-col items-center justify-center rounded-lg shadow-lg bg-Bokara-Grey">
            <Time
              type="time"
              value={selectedTime}
