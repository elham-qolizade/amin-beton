...
function SaleProject() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!newOrder.delivery_datetime) {
      setErrors((prev) => ({
        ...prev,
        delivery_datetime: "❌ لطفاً ساعت تحویل را انتخاب کنید.",
      }));
      toast.error("❌ لطفاً ساعت تحویل را انتخاب کنید.");
      formValid = false;
    } else {
      // پاک کردن ارور اگر ساعت درست بود
      setErrors((prev) => ({
        ...prev,
        delivery_datetime: "",
      }));
    ...
    if (!newOrder.delivery_datetime) {
      setErrors((prev) => ({
        ...prev,
        delivery_datetime: "⚠ لطفاً تاریخ تحویل را انتخاب کنید.",
      }));
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        <div className="flex flex-col items-center justify-center gap-4 md:flex-row ">
          ...
          {errors.delivery_datetime && (
            <p className="text-red text-sm mt-1">{errors.delivery_datetime}</p>
          )}
