  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // ❗ پاک کردن مقدارهای انتخابی بعد از گرفتن گزینه‌ها
        setNewOrder((prev) => ({
          ...res.data, // یا هرچی که مقدار رو از سرور می‌گیره
          concrete_type: "",
          concrete_pouring_type: "",
          concrete_resistance_class: "",
        }));
        console.log("concrete_type بعد از fetchData:", newOrder.concrete_type);
      } catch (err) {
        ...
        <div>
          ...
          <Select
            ...
            value={
              newOrder.concrete_type
                ? concreteTypes.find(
                    (o) => String(o.value) === String(newOrder.concrete_type)
                  )
                : null
            }
            onChange={(selected) =>
              setNewOrder((prev) => ({
                ...prev,
                concrete_type: selected?.value?.toString() || "",
              }))
            }
