  ...
  return (
    <div className="min-h-screen bg-b-gray">
      ...
      <div className="container flex flex-col px-4 text-right md:px-8">
        ...
        >
          <button
            className="bg-School-Bus mt-4 text-white p-2 rounded-lg font-medium "
              ...
              >
                ...
                {orders && (
                  <>
                    ...
                    <div style={{ marginBottom: 15 }}>
                      <strong>متراژ لوله‌کشی: </strong>{" "}
                      {orders.piping_area_size} مترمربع
                    </div>
                    <div style={{ marginBottom: 15 }}>
                    ...
                    <div style={{ marginBottom: 20 }}>
                      <strong>وضعیت: </strong>{" "}
                      <span
                        style={{ color: orders.verified ? "green" : "red" }}
                      >
