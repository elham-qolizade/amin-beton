    ...
    <div className="min-h-screen bg-b-gray">
      ...
      <div className="container flex flex-col text-right px-4 md:px-8">
        ...
        <div className="py-6 md:py-10 border-b border-white">
          <p className="text-xs md:text-sm text-School-Bus">
        ...
        <div className="py-6 md:py-10 border-b border-white">
          <div className="flex flex-col gap-4">
            <p className="text-sm md:text-lg text-white">1 متر مکعب</p>
            <p className="text-sm md:text-lg text-white">1 متر مکعب مرجوعی</p>
            <p className="text-sm md:text-lg text-white">تعداد ماشین</p>
          </div>
        </div>
