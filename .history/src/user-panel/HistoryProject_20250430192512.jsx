                ...
                {factor.factor && (
                  <div className="flex flex-col items-center justify-center w-full gap-4 mt-4 md:w-auto">
                    <button
                      ...
                      className="flex hover:text-School-Bus items-center justify-center  px-4 py-2 text-white border border-white rounded-lg md:w-full md:px-6 md:py-3 hover:border hover:border-School-Bus hover:bg-gray-700"
                    >
                      <span className="ml-2">
                        <svg
                          className="w-5 h-5"
