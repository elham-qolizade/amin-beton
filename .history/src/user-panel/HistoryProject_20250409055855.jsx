        ...
        <div className="flex flex-col text-right ">
          ...
          <div className="py-10 border-b border-white">
            <div className="flex flex-col gap-4">
              <p className="text-lg text-white">1 متر مکعب</p>
              <p className="text-lg text-white">1 متر مکعب مرجوعی</p>
              <p className="text-lg text-white">تعداد ماشین</p>
            </div>
          </div>

          {/* Pre-Invoice Section */}
          <div className="py-10 border-b border-white">
            <h2 className="mb-4 text-xl font-bold text-white">پیش فاکتورها</h2>
            {invoices.length === 0 ? (
                ...
                {invoices.map((invoice, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between w-full">
                        ...
                        <div className="flex flex-col gap-2">
                          {invoice.status === 3 && invoice.deny_reason && (
                            <div className="flex items-center">
                              ...
                              <p className="mr-2 text-lg font-semibold text-red">
                                {invoice.deny_reason}
                              </p>
                            </div>
                          )}
                      ...
                      <div className="flex flex-col gap-4 mr-10 mt-4">
                        {invoice.status === 1 && (
                          <button
                            onClick={() => {
          ...
          {/* Factor Section */}
          <div className="py-10 border-b border-white">
            <h2 className="mb-4 text-xl font-bold text-white">فاکتور</h2>
            {factor ? (
              factor.notFound ? (
                <div className="text-red">
          ...
          {/* Lab Section */}
          <div className="py-10 border-b border-white">
            <h2 className="mb-4 text-xl font-bold text-white">آزمایشگاه</h2>
            <div className="flex flex-col gap-4">
              <button
              ...
              <div className="flex gap-4">
                <button className="px-4 py-2 text-white bg-[#9F8E63] rounded-lg hover:bg-opacity-90">
                  آزمایش 14 روزه
                </button>
                <button className="px-4 py-2 text-white bg-gray-600 rounded-lg hover:bg-opacity-90">
                  آزمایش 7 روزه
                </button>
                <button className="px-4 py-2 text-white bg-gray-600 rounded-lg hover:bg-opacity-90">
                  آزمایش 3 روزه
          ...
          <div className="p-6 bg-gray-800 rounded-lg w-96">
            ...
            {reviewChoice === "reject" && (
              <div className="mt-4">
                ...
                <textarea
                  ...
                  className="mt-2 w-full p-2 bg-gray-700 text-white border border-gray-600 rounded-lg"
                  rows="3"
                />
              </div>
            )}
            ...
            <div className="mt-4 text-center">
              <button
                ...
                className="px-4 py-2 text-white bg-School-Bus rounded-lg hover:bg-opacity-90"
