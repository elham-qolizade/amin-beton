...
export default function OrdersPage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-Bokara-Grey">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
            ...
            {projectInfo?.status === 1 && (
              <ButtonProject
                ...
                className="flex items-center h-10 p-1 justify-center w-full gap-2 text-sm sm:w-auto"
              >
      ...
      {!loading && !error && (
        <div className="flex flex-col w-full gap-4 px-5 py-8 text-white transition-all duration-200 bg-gray-800 border border-transparent rounded-sm cursor-pointer md:flex-row md:gap-20 hover:bg-gray-700 hover:border-yellow-400 focus:border-yellow-400">
