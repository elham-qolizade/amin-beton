        ...
        <div className="flex flex-col text-right ">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="py-10 border-b border-white bg-School-Bus">
              ...
              {invoices.map((invoice) => (
        <div key={invoice.id} className="p-4 bg-white border rounded-lg shadow">
          <p><strong>شماره سفارش:</strong> {invoice.order}</p>
          <p><strong>قیمت:</strong> {invoice.price.toLocaleString()} تومان</p>
          <p><strong>وضعیت:</strong> {statusMap[invoice.status]}</p>
          <a
