...
const HistoryProject = () => {
  ...
  useEffect(() => {
    if (bills.length > 0) {
      const initialImei = bills[0].device.imei; // دریافت imei بارنامه اول
      setSelectedImei(initialImei);
      getLocation(initialImei); // دریافت موقعیت راننده
    }
  }, [bills]);
              ...
              >
                ...
                <ButtonProject
                  onClick={() => {
                    ...
                    getLocation(bill.device.imei); // دریافت موقعیت برای imei انتخاب‌شده
                  }}
                >
                  📍 نمایش روی نقشه
                </ButtonProject>
