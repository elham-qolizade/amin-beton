          ...
          {projects.length === 0 ? (
            ...
            projects.map((p) => (
              <div
                ...
                className="relative flex h-56 w-full cursor-pointer flex-col justify-between rounded-2xl bg-[#1f1f1f] p-4 shadow-xl transition hover:scale-[1.02] hover:shadow-2xl md:h-64"
              >
                {/* سرآیند */}
