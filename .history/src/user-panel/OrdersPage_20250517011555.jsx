    ...
    <div className="min-h-screen overflow-x-hidden bg-Bokara-Grey">
      ...
      <div className="mx-auto">
        ...
        {projectInfo ? (
          <ProjectHeading
            ...
            subtitles={[
              ...
              `مجموع وزن کل خریدها: ${projectInfo.total_weight?.toLocaleString()} کیلوگرم`,
              `مجموع مبلغ پرداختی: ${projectInfo.total_paid?.toLocaleString()} ریال`,
        ...
        <div className="container flex flex-col gap-6 px-4 my-10 sm:flex-row sm:justify-between">
          ...
          {projectInfo && (
            <div className="w-full max-w-5xl px-4 py-6 mt-6 text-white bg-gray-900 rounded-lg shadow-md">
              ...
              <button
                ...
                className="px-4 py-2 mt-4 text-black bg-white rounded-md hover:bg-gray-200"
              >
                مشاهده گردش حساب
              </button>
            </div>
      ...
      {isPaymentsModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-Bokara-Grey bg-opacity-60">
          <div className="w-full max-w-2xl p-6 overflow-y-auto text-white bg-gray-800 rounded-lg max-h-[80vh]">
