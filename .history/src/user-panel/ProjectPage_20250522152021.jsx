            ...
            projects.map((p) => (
              ...
              >
                ...
                <span
                  className={
                    p.status === 1
                      ? "self-start rounded-full mt-2 bg-School-Bus px-3 py-1 text-xs font-medium text-emerald-400"
                      : p.status === 2
                      ? "self-start rounded-full mt-2 bg-red px-3 py-1 text-xs font-medium text-red-400"
                      : "self-start rounded-full mt-2 bg-School-Bus px-3 py-1 text-xs font-medium text-yellow-400"
                  }
                >
                  {p.status === 1
                    ? "در حال انجام"
