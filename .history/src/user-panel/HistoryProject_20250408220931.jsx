            ...
            >
              <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
                ...
                {/* <div className="w-full md:w-1/2">
                  {/* ارسال مختصات مختص به هر خودرو */}
                  <MapComponent
                    latitude={vehicle.latitude} // مختصات عرض جغرافیایی
                    longitude={vehicle.longitude} // مختصات طول جغرافیایی
                    width="100%"
                    height="300px"
                  />
                </div> */}
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  {bills.length === 0 ? (
                    <div className="col-span-2 text-center p-4 bg-red-500 rounded-lg text-white">
                      بارنامه‌ای ثبت نشده است.
                    </div>
                  ) : (
                    bills
                      .filter((bill) => bill.vehicleId === vehicle.id) // فیلتر بارنامه‌ها بر اساس ID خودرو
                      .map((bill) => (
                        <div
                        ...
                        >
                          ...
                          {/* نمایش نقشه مربوط به این بارنامه */}
                          {location && (
                            <div className="mt-6">
                              <h3 className="text-lg font-semibold">
                                موقعیت راننده
