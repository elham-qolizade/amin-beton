                  ...
                  <div className="flex flex-col items-start justify-between w-full md:flex-row md:items-center">
                    <div className="flex flex-col w-full gap-4 md:w-3/5">
                      <div className="flex items-center justify-center md:justify-start text-center md:text-left">
                        <p className="text-sm text-center items-center md:text-lg font-semibold text-white">
                          مبلغ:
                        </p>
                    ...
                    <div className="flex flex-col w-full gap-4 mt-4 mr-10 md:w-auto">
                      ...
                      {invoice.invoice_file && (
                        <button
                          ...
                          className="flex items-center w-1/2 md:w-full  px-4 justify-center md:px-6 md:py-3 text-white border border-white rounded-lg hover:bg-gray-700"
                        >
                          <span className="ml-2">
                            <svg
                              className="w-5 h-5"
