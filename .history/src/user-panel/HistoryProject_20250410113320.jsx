        ...
        <div className="py-6 border-b border-white md:py-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 mt-4">
              <button className="px-4 py-2 text-white rounded-lg bg-School-Bus hover:bg-opacity-90 md:w-auto">
                آزمایش 14 روزه
              </button>
              <button className="w-1/2 px-4 py-2 text-white bg-gray-600 rounded-lg hover:bg-opacity-90 md:w-auto">
                آزمایش 7 روزه
              </button>
              <button className="w-1/2 px-4 py-2 text-white bg-gray-600 rounded-lg hover:bg-opacity-90 md:w-auto">
                آزمایش 3 روزه
