                  ...
                  {key.includes("date") ? (
                    <div className="relative w-full text-black bg-gray-700 border rounded bg-Bokara-Grey border-Looking-Glass">
                      <DatePicker
                        ...
                        inputClass="bg-Looking-Glass border border-Looking-Glass w-full text-center text-white p-1 rounded-lg shadow-lg transition duration-300 ease-in-out transform hover:bg-yellow-500 hover:text-black hover:scale-105"
