  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-Bokara-Grey">
      ...
      <div className="flex justify-center">
        {projectInfo && (
          <div className="w-full max-w-5xl px-4 py-6 mt-6 text-white rounded-lg shadow-lg bg-Bokara-Grey">
            <h3 className="pb-2 mb-4 text-lg font-bold border-b border-gray-600">
              خلاصه مالی پروژه
            </h3>
      ...
      {isPaymentsModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
          <div className="w-full max-w-2xl p-6 bg-black text-white rounded-lg max-h-[80vh] overflow-hidden">
            <h2 className="pb-2 mb-4 text-xl font-bold text-center border-b">
              گردش حساب پروژه
            </h2>
