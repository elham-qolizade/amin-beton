        ...
        <div className="py-6   border-b border-white md:py-10">
          ...
          {factor ? (
            factor.notFound ? (
              ...
              <div className="flex md:flex-row flex-col  md:items-end items-center md:justify-between gap-4">
                ...
                {factor.factor && (
                  <div className="flex flex-col items-center justify-center w-full gap-4 mt-4 md:w-auto">
                    <button
                      ...
                      className="flex items-center justify-center w-full md:w-full px-4 py-2 md:px-6 md:py-3 text-white border border-white rounded-lg hover:border hover:border-School-Bus hover:text-School-Bus hover:bg-gray-700"
                    >
                      <span className="ml-2">
                        <svg
                          className="w-5 h-5"
