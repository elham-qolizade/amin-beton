    ...
    <div className="min-h-screen bg-b-gray">
      ...
      <div className="mt-20  mb-10">
        {orderStatus !== null ? (
          ...
          <div className="text-white">وضعیت سفارش یافت نشد</div>
        )}
      </div>
      ...
      <div className="container flex flex-col px-4 text-right md:px-8">
                    ...
                    <div className="flex flex-col items-center justify-center w-full gap-4 mt-4 md:w-auto">
                      ...
                      {invoice.invoice_file && (
                        <button
                          ...
                          className="flex hover:text-School-Bus items-center justify-center w-1/2 px-4 py-2 text-white border border-white rounded-lg md:w-full md:px-6 md:py-3 hover:border hover:border-School-Bus hover:bg-gray-700"
                        >
                          <span className="ml-2">
                            <svg
                              className="w-5 h-5"
        ...
        {/* Factor Section */}
        <div className="py-6 border-b border-white md:py-10">
          <h2 className="mb-4 md:mb-0 text-lg font-bold text-center text-white md:text-xl md:text-right">
            فاکتور
          </h2>
          {factor ? (
            factor.notFound ? (
              ...
              <div className="flex md:flex-row flex-col  md:items-end items-center md:justify-between gap-1">
                ...
                {factor.factor && (
                  <div className="flex flex-col items-center justify-center w-full gap-4 mt-4 md:w-auto">
                    <button
                      ...
                      className="flex hover:text-School-Bus items-center justify-center w-1/2 px-4 py-2 text-white border border-white rounded-lg md:w-[24.5vh] md:px-6 md:py-3 hover:border hover:border-School-Bus hover:bg-gray-700"
                    >
                      <span className="ml-2">
                        <svg
                          className="w-5 h-5"
            ...
            <div className="mt-6">
              {filteredResults.length > 0 ? (
                filteredResults.map((item) => (
                  <div
                    key={item.id}
                    className="mb-6 p-4 bg-gray-700 rounded-lg text-white"
                  >
                    ...
                    <a
                      ...
                      className="text-School-Bus underline"
                    >
                      مشاهده فایل آزمایش
                    </a>
                  </div>
          ...
          <div className="grid grid-cols-1 gap-6 py-6 mt-4 md:grid-cols-2">
            {bills.map((bill) => (
              ...
              >
                ...
                {/* دکمه نمایش نقشه */}
                <ButtonProject onClick={() => handleShowLocation(bill.IMEI)}>
