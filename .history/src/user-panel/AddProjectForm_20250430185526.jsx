              ...
              <div className="flex flex-row flex-wrap justify-center items-center gap-4 md:gap-6">
                ...
                <div className="relative w-full sm:w-[48%]">
                  ...
                  <DatePicker
                    ...
                    inputClass="w-full m-1 text-center text-sm md:text-base text-white bg-Bokara-Grey border border-[#FFD700] placeholder-[#aaa] p-2 rounded-lg shadow-md transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-yellow-400 hover:ring-2 hover:ring-School-Bus hover:scale-[1.03]"
