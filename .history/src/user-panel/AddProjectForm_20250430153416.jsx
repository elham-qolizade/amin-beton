                  ...
                  {key.includes("date") ? (
                    <div className="relative w-full text-black bg-gray-700 border rounded bg-Bokara-Grey border-Looking-Glass">
                      <DatePicker
                        ...
                        inputClass="w-full m-1 text-center text-sm md:text-base text-white bg-[#1f2937] border border-[#FFD700] placeholder-[#aaa] p-1 rounded-xl shadow-md transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-yellow-400 hover:ring-2 hover:ring-yellow-400 hover:scale-[1.03]"
