...
export default function OrdersPage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-Bokara-Grey">
      ...
      {!loading && !error && (
        <div className="flex flex-col items-center px-6 py-8 transition-all duration-200 bg-gray-800 border border-transparent rounded-sm cursor-pointer md:flex-row md:gap-20 hover:bg-gray-700 hover:border-yellow-400 focus:border-yellow-400">
