                  ...
                  <div className="flex flex-col items-start justify-between w-full md:flex-row md:items-center">
                    <div className="flex flex-col w-full gap-4 md:w-3/5">
                      <div className="flex items-center justify-start">
                        ...
                        <p className="mr-2 text-sm text-center md:text-lg font-semibold text-white">
                          {invoice.price
        ...
        <div className="py-6 md:py-10 border-b border-white">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 mt-4">
              <button className="px-4 py-2 text-white bg-[#9F8E63] rounded-lg hover:bg-opacity-90 w-1/2 md:w-auto">
                آزمایش 14 روزه
              </button>
