...
const HistoryProject = () => {
  ...
  return (
    <div className="min-h-screen bg-b-gray">
      ...
      >
        <button
          className="bg-School-Bus mt-10 text-white p-2 rounded-lg font-medium "
      ...
      <div className="container flex flex-col px-4 text-right md:px-8">
        ...
        <div className="grid grid-cols-1 border-b border-white gap-6 py-6 mt-4 md:grid-cols-2">
