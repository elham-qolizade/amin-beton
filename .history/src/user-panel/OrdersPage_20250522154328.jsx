        ...
        {projectInfo && (
          <div className="w-full max-w-5xl px-4 py-6 mt-6 text-white rounded-lg shadow-lg bg-Bokara-Grey">
            ...
            <button
              ...
              className="px-4 py-2 mt-4 text-black bg-white rounded-md hover:text-white hover:bg-School-Bus"
            >
              مشاهده گردش حساب
            </button>
          </div>
          ...
          <div className="w-full max-w-2xl p-6 bg-black text-white rounded-lg max-h-[80vh] overflow-hidden">
            ...
            <div className="flex justify-end mt-4">
              <button
                ...
                className="px-4 py-2 text-black bg-white rounded hover:text-white hover:bg-School-Bus"
              >
                بستن
              </button>
            </div>
