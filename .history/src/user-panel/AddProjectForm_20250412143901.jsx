            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {Object.keys(values).map((key) => (
                <div key={key} className="relative">
                  ...
                  {key.includes("date") ? (
                    <div className="relative w-full text-black bg-gray-700 border rounded bg-Bokara-Grey border-l-Looking-Glass">
                      <DatePicker
                        calendar={persian}
                        locale={persian_fa}
                        value={values[key]}
                        ...
                        inputClass="bg-Looking-Glass w-full text-center text-white p-1 rounded"
