    ...
    <div className="min-h-screen overflow-x-hidden bg-Bokara-Grey">
      ...
      {isPaymentsModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
          <div className="w-full max-w-2xl p-6 bg-gray-800 text-white rounded-lg max-h-[80vh] overflow-hidden">
            ...
            <div className="flex justify-end mt-4">
              <button
                ...
                className="px-4 py-2 text-black bg-white rounded hover:bg-yellow-400"
              >
                بستن
              </button>
            </div>
