          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
            ...
            {projectInfo?.status === 1 && (
              <ButtonProject
                ...
                className="flex items-center h-10 justify-center w-full gap-2 text-sm sm:w-auto transition-all duration-200 bg-gray-800 border border-transparent rounded-sm cursor-pointer md:flex-row md:gap-20 hover:bg-School-Bus hover:border-yellow-400 focus:border-yellow-400"
              >
