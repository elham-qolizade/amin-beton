...
const HistoryProject = () => {
  ...
  const handleStatusChange = async (invoiceId, status, denyReason = "") => {
    // ساخت داده‌ها برای ارسال به API
    const data = {
    ...
    try {
      // ارسال درخواست برای تغییر وضعیت فاکتور
      await axios.post(
      ...
      // چاپ مقادیر مختلف برای بررسی
      console.log("Invoice ID:", invoiceId); // چاپ invoiceId
      console.log("Status:", status); // چاپ وضعیت
      console.log("Deny Reason:", denyReason); // چاپ دلیل رد (در صورت وجود)
