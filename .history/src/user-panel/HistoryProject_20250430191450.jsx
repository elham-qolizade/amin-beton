              ...
              <div className="flex flex-col gap-4">
                ...
                {factor.factor && (
                  <button
                    ...
                    className="flex hover:border hover:border-School-Bus hover:text-School-Bus items-center px-6 py-3 text-white border border-white rounded-lg hover:bg-gray-700"
                  >
                    <span className="ml-2">
                      <svg
                        className="w-5 h-5"
