    ...
    <div className="min-h-screen bg-b-gray">
      ...
      <div className="container flex flex-col px-4 text-right md:px-8">
        ...
        {orders ? (
          <div>
            <p>
              <strong>شماره سفارش:</strong> {order.order_id}
            </p>
            <p>
              <strong>نام سفارش:</strong> {order.order_name}
            </p>
            <p>
              <strong>زمان تحویل:</strong> {order.delivery_datetime}
            </p>
            <p>
              <strong>مبلغ پرداخت شده:</strong> {order.total_paid_amount}
            </p>
            <p>
              <strong>متراژ بتن:</strong> {order.concrete_area_size}
            </p>
            <p>
              <strong>متراژ لوله‌کشی:</strong> {order.piping_area_size}
            </p>
            <p>
              <strong>ارتفاع بتن‌ریزی:</strong> {order.concrete_pouring_height}
            </p>
            <p>
              <strong>اجرای آب‌بندی:</strong> {order.sealing_implementation}
            </p>
            <p>
              <strong>ماله پروانه‌ای:</strong>{" "}
              {order.power_trowel ? "بله" : "خیر"}
            </p>
            <p>
              <strong>تعداد ماله پروانه:</strong> {order.power_trowel_count}
            </p>
            <p>
              <strong>شیفت:</strong> {order.shift}
            </p>
            <p>
              <strong>نوع تسویه:</strong> {order.settlement_type}
            </p>
            <p>
              <strong>توضیحات تکمیلی:</strong>{" "}
              {order.additional_description || "ندارد"}
            </p>
            <p>
              <strong>تایید شده:</strong> {order.verified ? "بله" : "خیر"}
            </p>
            <p>
              <strong>وضعیت:</strong> {order.status}
            </p>
            <p>
              <strong>قیمت نهایی:</strong> {order.price}
            </p>
            <p>
              <strong>نوع بتن:</strong> {order.concrete_type}
            </p>
            <p>
              <strong>مقطع بتن‌ریزی:</strong> {order.concrete_pouring_type}
            </p>
            <p>
              <strong>رده مقاومتی بتن:</strong>{" "}
              {order.concrete_resistance_class}
            </p>
          </div>
        ) : (
