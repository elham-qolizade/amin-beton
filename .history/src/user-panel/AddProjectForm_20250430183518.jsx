              ...
              <div className="flex  flex-col  md:justify-center  md:flex-row md:items-center  md:gap-6">
                ...
                <div className="relative w-full md:w-1/2">
                  ...
                  <DatePicker
                    ...
                    inputClass="w-full m-1 z-2 text-center text-sm md:text-base text-white bg-Bokara-Grey  border border-[#FFD700] placeholder-[#aaa] p-2 rounded-lg shadow-md transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-School-Bus hover:ring-2 hover:ring-yellow-400 hover:scale-[1.03]"
