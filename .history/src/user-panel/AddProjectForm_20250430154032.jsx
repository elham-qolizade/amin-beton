                ...
                return (
                  <div key={key} className="relative">
                    ...
                    <Input
                      ...
                      className="w-full p-2 px-4 py-2 text-white bg-gray-700 border rounded-xl bg-Bokara-Grey border-Looking-Glass placeholder:text-gray-400"
                    />
                    {errors[key] && (
              ...
              <div className="flex flex-col md:flex-row md:items-center md:gap-6">
                ...
                <div className="relative w-full md:w-1/2">
                  ...
                  <DatePicker
                    ...
                    inputClass="w-full m-1 text-center text-sm md:text-base text-white bg-[#1f2937] border border-[#FFD700] placeholder-[#aaa] p-2 rounded-xl shadow-md transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-yellow-400 hover:ring-2 hover:ring-yellow-400 hover:scale-[1.03]"
                ...
                <div className="relative w-full md:w-1/2 mt-4 md:mt-0">
                  ...
                  <DatePicker
                    ...
                    inputClass="w-full m-1 text-center text-sm md:text-base text-white bg-Bokara-Grey  border border-[#FFD700] placeholder-[#aaa] p-2 rounded-xl shadow-md transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-yellow-400 hover:ring-2 hover:ring-yellow-400 hover:scale-[1.03]"
                    placeholder="روز / ماه / سال"
                  />
                  {errors.end_date && (
                    <div className="absolute text-sm text-red">
