        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60">
          <div className="p-10 text-center text-black border rounded-lg border-School-Bus bg-Bokara-Grey w-96">
            ...
            <div className="flex justify-between mt-5">
              <button
                className="px-4 py-2 bg-black rounded-md hover:text-white hover:bg-red text-School-Bus"
                onClick={() => setIsActionModalOpen(false)}
              >
                انصراف
              </button>
              <button
                className="px-4 py-2 text-black bg-white rounded-md hover:bg-School-Bus hover:text-white"
