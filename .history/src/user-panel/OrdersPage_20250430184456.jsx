          ...
          <div className="grid w-full max-w-5xl grid-cols-1 gap-6 md:grid-cols-2">
            {purchases.map((purchase) => (
              <div
                ...
                key={purchase.id}
                className="flex flex-col w-full gap-4 px-5 py-8 text-white transition-all duration-200 bg-gray-800 border rounded-sm cursor-pointer md:flex-row md:gap-20 hover:bg-gray-700 hover:bg-gray-700 hover:border-School-Bus focus:border-School-Bus"
              >
