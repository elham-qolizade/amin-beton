            ...
            <form onSubmit={handleSubmit} className="justify-center space-y-4">
              {Object.keys(values).map((key) => (
                <div key={key} className="relative">
                  ...
                  {key.includes("date") ? (
                    <div className="relative w-full p-1 px-4 py-2 pl-4 text-red bg-gray-700 border rounded ltr-input bg-Bokara-Grey border-l-Looking-Glass focus:outline-none focus:ring-1 focus:ring-School-Bus border-Looking-Glass">
                      <DatePicker
