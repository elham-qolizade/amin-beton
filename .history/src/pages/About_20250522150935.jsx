      ...
      <div className="container px-4 py-10 mx-auto sm:px-6 lg:px-10">
        <div className="flex flex-col gap-4 text-white text-start">
          <p className="text-sm sm:text-base md:text-lg">
            کارخانه امین بتن با سال‌ها تجربه در تولید بتن آماده و محصولات بتنی،
            با بهره‌گیری از ماشین‌آلات به‌روز و نیروی متخصص، تلاش می‌کند تا
            نیازهای پروژه‌های عمرانی و ساختمانی را با بالاترین کیفیت و در
            کوتاه‌ترین زمان تأمین کند. ما متعهد به ارائه بتن با مقاومت بالا، دقت
            در زمان‌بندی تحویل و رعایت کامل استانداردهای ملی و بین‌المللی هستیم.
          </p>
