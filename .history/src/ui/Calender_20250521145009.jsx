...
const CustomCalendar = ({ selectedDay, setSelectedDay }) => {
  ...
  const handleDateChange = (date) => {
    ...
    // نمایش انتخاب زمان فقط زمانی که تاریخ انتخاب شده
  };
  ...
  const handleTimeChange = (newTime) => {
    ...
    if (convertedDate && newTime) {
      sendToServer(convertedDate, newTime); // shift حذف شد
    }
  };
  ...
  return (
    <div className="flex flex-col items-center  gap-6 p-4 text-white bg-Bokara-Grey">
