...
const ProgressCircle = ({ status }) => {
  const radius = 80; // اندازه دایره بزرگتر شد
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[22%] left-[85%] transform -translate-x-1/2 text-white text-xs">
        تایید امین بتن
      </div>
      <div className="absolute top-[45%] left-[90%] transform -translate-x-1/2 text-white text-xs">
        خرید اولیه
      </div>
      <div className="absolute top-[68%] left-[85%] transform -translate-x-1/2 text-white text-xs">
        دریافت
      </div>
      <div className="absolute top-[80%] left-[50%] transform -translate-x-1/2 text-white text-xs">
        اجرا
      </div>
      <div className="absolute top-[68%] left-[15%] transform -translate-x-1/2 text-white text-xs">
        ارسال
      </div>
      <div className="absolute top-[45%] left-[5%] transform -translate-x-1/2 text-white text-xs">
        تایید پیش فاکتور
      </div>
    </div>
  );
