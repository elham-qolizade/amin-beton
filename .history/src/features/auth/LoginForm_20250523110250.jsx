        ...
        >
          ...
          {!otpSent ? (
            ...
            <div className="flex flex-col items-center gap-6">
              <div className="flex flex-row-reverse justify-center w-fit gap-2">
                {[...Array(6)].map((_, index) => (
                  <div key={index} className="flex flex-col items-center">
                    <Input
                      ...
                      inputMode="numeric"
                      maxLength="1"
                      className="flex justify-center text-2xl text-center border rounded-md w-14 h-14 sm:w-16 sm:h-16 ps-0"
              ...
              <Button
                type="submit"
                className="font-semibold bg-yellow-500 rounded px-12 py-3"
              >
                ورود
              </Button>
            </div>
