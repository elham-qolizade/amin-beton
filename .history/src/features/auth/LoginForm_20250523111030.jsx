        ...
        >
          ...
          {!otpSent ? (
            ...
            <div className="flex flex-col items-center gap-6 w-full">
              <div className="grid grid-cols-6 gap-2 justify-center sm:w-fit w-full max-w-xs">
                {[...Array(6)].map((_, index) => (
                  <Input
                    key={index}
                    id={`otp-${index}`}
                    ...
                    inputMode="numeric"
                    maxLength="1"
                    className="text-2xl text-center border rounded-md h-14 sm:w-16 w-full"
              ...
              <Button
                type="submit"
                className="w-full max-w-xs sm:w-fit px-6 py-3 font-semibold bg-yellow-500 rounded"
              >
                ورود
              </Button>
            </div>
