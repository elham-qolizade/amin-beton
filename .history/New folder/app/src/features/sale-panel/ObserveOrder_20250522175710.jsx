                    ...
                    {isEditMode ? (
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          const selectedId = parseInt(e.target.value);
                          updated[index].vibrator = selectedId;
                      ...
                      >
                        <option value="">انتخاب کنید</option>
                        {Object.keys(vibratorMapping).map((id) => (
                    ...
                    {isEditMode ? (
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          updated[index].sub_vibrator = selectedSubId;
                          setEditableOrder((prev) => ({
                            ...prev,
                            vibrators: updated,
                          }));
                      ...
                      >
                        <option value="">ندارد</option>
                        {vibrator.vibrator &&
                          Object.keys(subVibratorMapping).map((id) => (
                            <option key={id} value={id}>
                              {subVibratorMapping[id]}
                            </option>
                          ))}
                      </select>
