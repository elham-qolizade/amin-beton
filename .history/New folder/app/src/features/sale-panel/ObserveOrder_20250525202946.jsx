...
import fa from "date-fns-jalali/locale/fa";
  ...
  return (
    <StyledObserveOrder>
      ...
      <Info>
        ...
        import DatePicker from "react-datepicker"; import {parseISO} from
        "date-fns"; import {registerLocale} from "react-datepicker"; import fa
        from "date-fns-jalali/locale/fa"; registerLocale("fa", fa);
            ...
            <DatePicker
              selected={
                editableOrder.delivery_datetime
                  ? parseISO(editableOrder.delivery_datetime)
                  : null
              }
              onChange={(date) =>
                handleChange("delivery_datetime", date?.toISOString())
              }
              showTimeSelect
              timeFormat="HH:mm"
              timeIntervals={15}
