          ...
          {isEditMode ? (
            <ul style={{ padding: 0, listStyle: "none" }}>
              <li
                style={{
                  cursor: "pointer",
                  fontWeight: !vibrator.sub_vibrator ? "bold" : "normal",
                }}
                onClick={() => {
                  const updated = [...editableOrder.vibrators];
                  updated[index].sub_vibrator = null; // انتخاب "ندارد"
                  setEditableOrder((prev) => ({
                    ...prev,
                    vibrators: updated,
                  }));
              ...
              {(
                ...
                <li
                  ...
                  style={{
                    cursor: "pointer",
                    fontWeight:
                      vibrator.sub_vibrator?.id === sv.id ? "bold" : "normal",
                  }}
                  onClick={() => {
                    const updated = [...editableOrder.vibrators];
                    updated[index].sub_vibrator = sv;
                    setEditableOrder((prev) => ({
                      ...prev,
                      vibrators: updated,
                    }));
