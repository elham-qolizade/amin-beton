                    ...
                    {isEditMode ? (
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          const selectedVibratorId = vibrator.vibrator?.id;
                          const selectedVibratorFromList = vibratorList.find(
                            (v) => v.id === selectedVibratorId
                          );

                          if (selectedVibratorFromList) {
                            const selectedSub =
                              selectedVibratorFromList.sub_vibrators?.find(
