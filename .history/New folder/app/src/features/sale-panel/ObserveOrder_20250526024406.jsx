...
function ObserveOrder({ order, onUpdate }) {
  ...
  const validateForm = () => {
    ...
    editableOrder.pumps.forEach((pump, index) => {
      ...
      // ولیدیشن ساب پمپ: اگر پمپ اصلی انتخاب شده ولی ساب پمپ انتخاب نشده
      if (pump.pump && (pump.sub_pump === null || pump.sub_pump?.id == null)) {
        errors[`sub_pump_${index}`] = `زیرمجموعه پمپ شماره ${
          index + 1
        } باید انتخاب شود.`;
      }
    });
                  ...
                  <InfoItem>
                    ...
                    {isEditMode ? (
                      <>
                        ...
                        {/* نمایش خطای نوع پمپ */}
                        {errors[`pump_${index}`] && (
                          <ErrorMessage>{errors[`pump_${index}`]}</ErrorMessage>
                        )}
                      </>
                    ) : (
                  ...
                  <InfoItem>
                    ...
                    {isEditMode ? (
                      <>
                        ...
                        />
                        {/* نمایش خطای تعداد پمپ */}
                        {errors[`pump_count_${index}`] && (
                          <ErrorMessage>
                            {errors[`pump_count_${index}`]}
                          </ErrorMessage>
                        )}
