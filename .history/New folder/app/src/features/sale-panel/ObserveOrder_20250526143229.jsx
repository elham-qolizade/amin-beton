  ...
  const validateForm = () => {
    ...
    editableOrder.pumps.forEach((pump, index) => {
      ...
      if (!pump.pump || !pump.pump.id) {
        pumpErrors.pump = "لطفاً نوع پمپ را انتخاب کنید.";
      }
      ...
      if (
        ...
        pumpErrors.sub_pump = "لطفاً یک زیرپمپ انتخاب کنید.";
      }

      if (Object.keys(pumpErrors).length > 0) {
        errors[`pump_${index}`] = pumpErrors;
      }
    });
