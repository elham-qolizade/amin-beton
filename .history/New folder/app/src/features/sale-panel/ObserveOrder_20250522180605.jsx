              ...
              <div key={index} className="flex gap-4 mb-2">
                ...
                {isEditMode ? (
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      updated[index].vibrator = selectedVibrator || null;
                      updated[index].sub_vibrator = null; // وقتی ویبراتور اصلی تغییر کرد، زیر ویبراتور ریست بشه
                  ...
                  <span>
                    {
                      vibratorList.find((v) => v.id === vibrator.vibrator?.id)?.title ||
                      "ندارد"
                    }
                  </span>
                )}
                ...
                {isEditMode ? (
                  <select
                    ...
                    disabled={!vibrator.vibrator}
                  >
                    <option value="">ندارد</option>
                    {vibrator.vibrator &&
                      vibratorList
                        .find((v) => v.id === vibrator.vibrator?.id)
                  ...
                  <span>
                    {
                      vibratorList
                        .find((v) => v.id === vibrator.vibrator?.id)
                        ?.sub_vibrators?.find((sv) => sv.id === vibrator.sub_vibrator?.id)
                        ?.title || "ندارد"
                    }
                  </span>
                )}
