...
function ObserveOrder({ order }) {
  ...
  const [pumps, setPumps] = useState(order.pumps || []);
  ...
  const handleAddPump = () => {
    ...
    setNewPump({ pump: null, sub_pump: null, count: 1 });
  };
            ...
            editableOrder.pumps.map((pump, index) => (
              <Pump key={index}>
                ...
                <InfoItem>
                  ...
                  {isEditMode ? (
                    <input
                      value={pump.sub_pump?.title || ""}
                      onChange={(e) => {
                        const updated = [...editableOrder.pumps];
                        updated[index].sub_pump = { title: e.target.value };
                        setEditableOrder((prev) => ({
                          ...prev,
                          pumps: updated,
                        }));
                ...
                <InfoItem>افزودن پمپ جدید</InfoItem>
                <InfoItem>
                  <select
                    onChange={(e) =>
                      setNewPump({
                ...
                <InfoItem>
                  ...
                  {isEditMode ? (
                    <input
                      ...
                      onChange={(e) => {
                        const updated = [...editableOrder.vibrators];
                        updated[index].sub_vibrator = { title: e.target.value };
                        setEditableOrder((prev) => ({
                          ...prev,
                          vibrators: updated,
                        }));
