      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-10 py-10">
        <div className="flex flex-col gap-4 text-white text-start">
          <p className="text-sm sm:text-base md:text-lg">
            دال های ما با استفاده از جدیدترین فناوری‌ها و بهترین مواد اولیه
        ...
        <div className="flex flex-col gap-4 py-10">
          <p className="text-white text-sm sm:text-base md:text-lg">
            دال های بتنی ما می‌توانند به بهبود سرعت ساخت، کاهش هزینه‌ها و افزایش
            کیفیت کلی پروژه شما کمک کنند. برای مشاوره و انتخاب بهترین محصول، با
            تیم ما تماس بگیرید.
          </p>
        </div>
      </div>
