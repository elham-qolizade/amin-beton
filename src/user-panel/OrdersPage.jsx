    ...
    <div className="min-h-screen overflow-x-hidden bg-Bokara-Grey">
      ...
      {isActionModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 px-4">
          <div className="p-6 sm:p-10 text-center text-black border rounded-lg border-School-Bus bg-Bokara-Grey w-full max-w-md">
            <h3 className="text-xl sm:text-2xl font-bold text-red">هشدار</h3>
            <p className="mt-3 text-sm sm:text-lg text-School-Bus">
              {modalAction === "close"
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-3 mt-6">
              <button
                className="w-full sm:w-auto px-4 py-2 bg-black rounded-md hover:text-white hover:bg-red text-School-Bus"
                onClick={() => setIsActionModalOpen(false)}
              >
                انصراف
              </button>
              <button
                className="w-full sm:w-auto px-4 py-2 text-black bg-white rounded-md hover:bg-School-Bus hover:text-white"
