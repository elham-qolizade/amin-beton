...
function ConfirmedOrderRow({ order }) {
  ...
  return (
    <Table.Row>
      ...
      <Table.Cell>{order.project?.title}</Table.Cell>
      <Table.Cell>{order.project?.user_fullname}</Table.Cell>
      <Table.Cell>{order.project?.user_phone}</Table.Cell>
      <Table.Cell>{order.project?.user_username}</Table.Cell>
      <Table.Cell>{order.project?.user_id}</Table.Cell>
    </Table.Row>
  );
}
