...
import { FaEye, FaRegStickyNote, FaTruck } from "react-icons/fa"; // اضافه کردن FaTruck
...
function ConfirmedOrderRow({ order }) {
  ...
  const { isSending: isFactorSending, sendFactor } = useAddFactorAndPrice();
    ...
    <Table.Row>
      <Modal>
        ...
        <Modal.Window name="transport">
          <div>اینجا می‌توانید اطلاعات حمل و نقل را نمایش دهید.</div>
        </Modal.Window>
