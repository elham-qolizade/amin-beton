...
const WatchIcon = styled(IconWrapper)`
  display: flex;
  justify-content: center;
  align-items: center;
  cursor: pointer;
...
const FactorPreviewIcon = styled(IconWrapper)`
  display: flex;
  justify-content: center;
  align-items: center;
  cursor: pointer;
...
`;
const CheckmarkIcon = styled(IconWrapper)`
  display: flex;
  justify-content: center;
  align-items: center;
  cursor: pointer;
...
`;
const NoteIcon = styled(IconWrapper)`
  display: flex;
  justify-content: center;
  align-items: center;
  cursor: pointer;
...
const SmsIcon = styled(IconWrapper)`
  display: flex;
  justify-content: center;
  align-items: center;
  cursor: pointer;
  ...
  return (
    <Table.Row>
      <Modal>
        ...
        {/* تحویل سفارش */}
        <CheckmarkIcon
          onClick={order.status !== 7 ? handleDeliverOrder : null}
          style={{
            opacity: order.status === 7 ? 0.5 : 1,
            pointerEvents: order.status === 7 ? "none" : "auto",
          }}
        >
