    ...
    <Modal>
      ...
      <Modal.Window name="location">
        <div style={{ height: "300px", width: "100%" }}>
          ...
          >
            <Geographies geography="https://raw.githubusercontent.com/evansiroky/world-atlas/master/countries-50m.json">
              {({ geographies }) =>
                geographies.map((geo) => (
                  <Geography
                    key={geo.rsmKey}
  ...
  return (
    <Table.Row>
      <Modal>
        ...
        <LocationModal order={order} />{" "}
        {/* اینجا کامپوننت موقعیت را فراخوانی می‌کنیم */}
